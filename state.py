...
class State(object):
    ...
    def get_counteraction_challenges(self, challenger):
        ...
        # if challenger == self.counteraction.action.player: # we modify the game so the actor cannot challenge a counteraction, making the transitions easier to model
        #     return counteraction_challenges
