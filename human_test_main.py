...
def info():
    ...
    c = choose_from_list(["Consent and continue.", "Quit."])
    if c == 1:
        quit()
    ...
    xp = choose_from_list(["First time playing.", "Played before a few times.", "Have played fairly regularly before.", "I have played Coup a lot.", "I consider myself very skilled at Coup."])
